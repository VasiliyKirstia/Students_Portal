...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='book',
            name='tags',
            field=models.ManyToManyField(to='library.Tag', verbose_name='теги', related_name='books'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='user',
            field=models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='books'),
            preserve_default=True,
        ),
    ]

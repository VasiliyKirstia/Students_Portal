    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(verbose_name='Категория', to='films.Category', related_name='categories')),
